  ...
  class Options
    ...
    def self.available_options
      ...
      [
        ...
        # Storage: Rest API Storage
        FastlaneCore::ConfigItem.new(key: :rest_api_storage_download_proc,
                                     type: Proc,
                                     description: "Rest API Storage Proc block for downloading file",
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :rest_api_storage_upload_proc,
                                     type: Proc,
                                     description: "Rest API Storage Proc block for uploading file",
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :rest_api_storage_delete_proc,
                                     type: Proc,
                                     description: "Rest API Storage Proc block for deleting file",
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :rest_api_storage_list_proc,
                                     type: Proc,
                                     description: "Rest API Storage Proc block for listing files",
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :rest_api_storage_auth_params,
                                     type: Hash,
